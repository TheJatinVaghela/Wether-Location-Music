...
function Wether(location) {
  return new Promise((resolve, reject) => {
    ...
    fetch(`https://weatherbit-v1-mashape.p.rapidapi.com/forecast/3hourly?lat=${location.latitude}&lon=${location.longitude}`, Wether)
      .then(response => response.json())
      .then( response => {
